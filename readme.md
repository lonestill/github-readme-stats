...
<p align="center">
  <a href="https://github.com/lonestill/github-readme-stats/actions">
    <img alt="Tests Passing" src="https://github.com/lonestill/github-readme-stats/workflows/Test/badge.svg" />
  </a>
  <a href="https://github.com/lonestill/github-readme-stats/graphs/contributors">
    <img alt="GitHub Contributors" src="https://img.shields.io/github/contributors/lonestill/github-readme-stats" />
  </a>
  <a href="https://github.com/lonestill/github-readme-stats/issues">
    <img alt="Issues" src="https://img.shields.io/github/issues/lonestill/github-readme-stats?color=0088ff" />
  </a>
  <a href="https://github.com/lonestill/github-readme-stats/pulls">
    <img alt="GitHub pull requests" src="https://img.shields.io/github/issues-pr/lonestill/github-readme-stats?color=0088ff" />
  </a>
</p>
...
> [!IMPORTANT]
> Since the GitHub API only allows 5k requests per hour per user account, the public Vercel instance could hit the rate limiter. Caching is used to prevent this (see [Common Options](#common-options)). You can deploy your own Vercel instance to avoid rate limits.
...
Since GitHub will re-upload the cards and serve them from their CDN, we can not infer the browser/GitHub theme on the server side. There are, however, four methods you can use to create dynamic themes on the client side.
...
You can use GitHub's new media feature in HTML to specify whether to display images for light or dark themes:
...
| Code | Locale | Code | Locale | Code | Locale |
| --- | --- | --- | --- | --- | --- |
| `ar` | Arabic | `he` | Hebrew | `ru` | Russian |
| `az` | Azerbaijani | `hi` | Hindi | `sa` | Sanskrit |
| `bn` | Bengali | `hu` | Hungarian | `sr` | Serbian (Cyrillic) |
| `bg` | Bulgarian | `id` | Indonesian | `sr-latn` | Serbian (Latin) |
| `my` | Burmese | `it` | Italian | `sk` | Slovak |
| `ca` | Catalan | `ja` | Japanese | `es` | Spanish |
| `cn` | Chinese | `kr` | Korean | `sw` | Swahili |
| `zh-tw` | Chinese (Taiwan) | `ml` | Malayalam | `se` | Swedish |
| `cs` | Czech | `np` | Nepali | `ta` | Tamil |
| `nl` | Dutch | `no` | Norwegian | `th` | Thai |
| `en` | English | `fa` | Persian (Farsi) | `tr` | Turkish |
| `fil` | Filipino | `pl` | Polish | `uk-ua` | Ukrainian |
| `fi` | Finnish | `pt-br` | Portuguese (Brazil) | `ur` | Urdu |
| `fr` | French | `pt-pt` | Portuguese (Portugal) | `uz` | Uzbek |
| `de` | German | `ro` | Romanian | `vi` | Vietnamese |
| `el` | Greek | | | | |
...
| `show` | Shows [additional items](#showing-additional-individual-stats) on stats card. | string (comma-separated values) | `null` |
| `commits_year` | Filters and counts only commits made in the specified year. | integer _(YYYY)_ | `<current year> (one year to date)` |

> [!WARNING]
> Custom title should be URI-escaped, as specified in [Percent Encoding](https://en.wikipedia.org/wiki/Percent-encoding). You can use [urlencoder.org](https://www.urlencoder.org/) to help you do this automatically.
...
> [!WARNING]
> This card shows language usage only inside your own non-forked repositories. It does not include your contributions into another users/organizations repositories.
...
> [!WARNING]
> Language names and custom title should be URI-escaped, as specified in [Percent Encoding](https://en.wikipedia.org/wiki/Percent-encoding). You can use [urlencoder.org](https://www.urlencoder.org/) to help you do this automatically.
...
Since the GitHub API only allows 5k requests per hour, the public Vercel instance could possibly hit the rate limiter. If you host it on your own Vercel server, then you do not have to worry about anything.

[![Deploy to Vercel](https://vercel.com/button)](https://vercel.com/import/project?template=https://github.com/lonestill/github-readme-stats)
...
5. Import this repository to Vercel.
6. Create a Personal Access Token (PAT) as described in the [previous section](#first-step-get-your-personal-access-token-pat).
7. Add the PAT as an environment variable named `PAT_1`.
8. Click deploy, and you're good to go. See your domains to use the API!
...
**Step-by-step guide for deploying on other platforms:**
